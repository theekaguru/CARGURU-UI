...
export default function FeaturedCars() {
  ...
  return (
    <section className="px-4 py-12 bg-[#0C1729] text-[#DCE3F0] transition-colors duration-300">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-4xl md:text-5xl font-extrabold text-center mb-8 text-[#E2ECFD] tracking-tight">
          Explore Our Top Picks
        </h2>
        <p className="text-center text-[#6896C0] mb-12 text-lg max-w-2xl mx-auto">
        ...
        {error ? (
          ...
          <div className="flex justify-center py-16">
            <PuffLoader color="#6896C0" size={50} />
          </div>
        ) : allCars.length === 0 ? (
          <div className="text-center text-[#6896C0]">No vehicles available at the moment.</div>
        ) : (
