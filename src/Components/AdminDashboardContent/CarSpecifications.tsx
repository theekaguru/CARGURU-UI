      ...
      <table className="table">
        ...
        <tbody>
          {error ? (
            ...
            <tr>
              <td colSpan={11} className="text-center">No Vehicle Specs Available</td>
            </tr>
          ) : (
            allVehicleSpecificationData.map((vehicleSpec: CarSpecificationInterface) => (
              <tr key={vehicleSpec.vehicleSpecId}>
                ...
                <td>
                  <button 
                    className="text-blue-500 hover:text-blue-400 btn btn-sm btn-outline" 
                  ...
                  <button 
                    ...
                    onClick={() => handleDelete(vehicleSpec.vehicleSpecId)}
                  >
                    <AiFillDelete />
                  </button>
                </td>
